package com.example.lapor_damkar;
...
public class LaporanProses extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laporan_proses);

        toolbar = findViewById(R.id.IDtoolbar);
        laporanProses = findViewById(R.id.LV);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                toolbar1 = new Intent(LaporanProses.this, MainActivity.class);
    ...
    public void getData(){
        initializeArray();
        //URL API
        AndroidNetworking.get("https://tekajeapunya.com/kelompok_9/lapordamkar/getLaporanProsesDamkar.php")
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (status){
                                ...
                                final CLV_LaporanProses adapter = new CLV_LaporanProses(LaporanProses.this,array_id,array_jenisLaporan,array_namaLengkap,array_maps,array_ltd,array_lng,array_lokasiDetail,array_tanngal,array_keterangan,array_statusLaporan,array_foto);

                                //Set adapter to list
                                laporanProses.setAdapter(adapter);

                                //detail
                                laporanProses.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    @Override
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {

                                        Intent i = new Intent(LaporanProses.this, DetailLaporanProses.class);
                                ...
                                Toast.makeText(LaporanProses.this, "Tidak Ada Laporan!", Toast.LENGTH_SHORT).show();
                            }
                        }
                        catch (Exception e){
                            e.printStackTrace();

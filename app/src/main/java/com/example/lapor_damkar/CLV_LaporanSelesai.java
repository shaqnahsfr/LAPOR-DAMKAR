...
public class CLV_LaporanSelesai extends ArrayAdapter<String> {
    ...
    public CLV_LaporanSelesai(Activity context, ArrayList<String> ID, ArrayList<String> JenisLaporan, ArrayList<String> NamaLengkap,
    ...
    {
        super(context, R.layout.list_item_laporan_selesai,JenisLaporan);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.list_item_laporan_selesai, null, true);

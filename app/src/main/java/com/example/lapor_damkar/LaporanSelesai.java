...
public class LaporanSelesai extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        laporanSelesai = findViewById(R.id.LV);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                toolbar1 = new Intent(LaporanSelesai.this, MainActivity.class);
    ...
    public void getData(){
        initializeArray();
        //URL API
        AndroidNetworking.get("https://tekajeapunya.com/kelompok_9/lapordamkar/getLaporanSelesaiDamkar.php")
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (status){
                                ...
                                final CLV_LaporanSelesai adapter = new CLV_LaporanSelesai(LaporanSelesai.this,array_id,array_jenisLaporan,array_namaLengkap,array_maps,array_ltd,array_lng,array_lokasiDetail,array_tanngal,array_keterangan,array_statusLaporan,array_foto);

                                //Set adapter to list
                                laporanSelesai.setAdapter(adapter);

                                //detail
                                laporanSelesai.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    @Override
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                         Intent i = new Intent(LaporanSelesai.this, DetailLaporanSelesai.class);
                                ...
                                Toast.makeText(LaporanSelesai.this, "Tidak Ada Laporan!", Toast.LENGTH_SHORT).show();
                            }
                        }
                        catch (Exception e){
                            e.printStackTrace();

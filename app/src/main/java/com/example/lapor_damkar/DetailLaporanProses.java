...
public class DetailLaporanProses extends AppCompatActivity implements OnMapReadyCallback {
    ...
    com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton done;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_laporan_proses);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                toolbar1 = new Intent(DetailLaporanProses.this, LaporanProses.class);
        ...
        done = findViewById(R.id.fab_btn);
    ...
    public void updateStatus(){
        AndroidNetworking.post("https://tekajeapunya.com/kelompok_9/laporpolisi/updateLaporan2.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(DetailLaporanProses.this, ""+pesan, Toast.LENGTH_SHORT).show();
                            Log.d("status",""+status);
                            if (status){
                                new AlertDialog.Builder(DetailLaporanProses.this)
                                        .setMessage("Telah diselesaikan!")
                                        .setCancelable(false)
                                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent page;
                                                page = new Intent(DetailLaporanProses.this,LaporanProses.class);
                                                startActivity(page);
                                            }
                                        })
                                        .show();

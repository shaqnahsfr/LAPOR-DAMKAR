...
public class CLV_LaporanMasuk extends ArrayAdapter<String> {
    ...
    public CLV_LaporanMasuk(Activity context, ArrayList<String> ID, ArrayList<String> JenisLaporan, ArrayList<String> NamaLengkap,
    ...
    {
        super(context, R.layout.list_item_laporan_masuk,JenisLaporan);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.list_item_laporan_masuk, null, true);
